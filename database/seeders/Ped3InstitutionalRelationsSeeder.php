...
class Ped3InstitutionalRelationsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->report($manifest, $relations, $newRelations, $missing, $ambiguous);
    ...
    private function report(array $manifest, array $relations, array $newRelations, array $missing, array $ambiguous): void
    {
