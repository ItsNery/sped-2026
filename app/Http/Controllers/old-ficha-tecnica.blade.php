...
<style>
    /* Estilos base para la nueva ficha */
    .ficha-section-title {
        color: {
                {
                $indicador->color ?? '#484747'
            }
        }
...
<div class="row" style="margin-left: auto; margin-right: auto;">
    @if ($indicador->programa == 'Humanismo con Bienestar' && $indicador->programa_derivado == 'Plan Estatal de Desarrollo')
    <img src="{{ asset('img/Banners/Banner_PED/Eje_1.jpg') }}" alt="banner del Eje 1" class="w-100 px-0">
    @elseif(
    $indicador->programa == 'Prosperidad y Estabilidad Económica' &&
    $indicador->programa_derivado == 'Plan Estatal de Desarrollo')
    <img src="{{ asset('img/Banners/Banner_PED/Eje_2.jpg') }}" alt="banner del Eje 2" class="w-100 px-0">
    @elseif(
    $indicador->programa == 'Estado de Derecho, Seguridad y Justicia' &&
    $indicador->programa_derivado == 'Plan Estatal de Desarrollo')
    <img src="{{ asset('img/Banners/Banner_PED/Eje_3.jpg') }}" alt="banner del Eje 3" class="w-100 px-0">
    @elseif(
    $indicador->programa == 'Desarrollo Urbano y Crecimiento Sostenible' &&
    $indicador->programa_derivado == 'Plan Estatal de Desarrollo')
    <img src="{{ asset('img/Banners/Banner_PED/Eje_4.jpg') }}" alt="banner del Eje 4" class="w-100 px-0">
    @elseif(
    $indicador->programa == 'Gobierno Transformador y de Resultados' &&
    $indicador->programa_derivado == 'Plan Estatal de Desarrollo')
    <img src="{{ asset('img/Banners/Banner_PED/Eje_5.jpg') }}" alt="banner del Eje 5" class="w-100 px-0">
    @elseif($indicador->programa == 'Por Amor a Puebla' && $indicador->programa_derivado == 'Plan Estatal de Desarrollo')
    <img src="{{ asset('img/Banners/Banner_PED/Eje_6.jpg') }}" alt="banner del Eje 6" class="w-100 px-0">
    @endif
</div>
<div class="row nav_ejes">
    @if ($indicador->programa_derivado == 'Plan Estatal de Desarrollo')
