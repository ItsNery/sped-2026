...
<img src="{{ asset('img/Banners/Banner_PED/Eje_5.webp') }}" alt="banner del Eje 1" class="w-100 px-0">
<div class="row nav_ejes">
    ...
    <div class="col-md-2 nav_eje_item nav_eje5_active ocultar_submenu">
...
<div class="row contenido">
    ...
    <div class="col-sm-12 col-md-7 objetivo_5">
        <p>
            ...
            Seremos un gobierno abierto, inclusivo y eficiente,
