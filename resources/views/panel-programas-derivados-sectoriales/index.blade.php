<x-app-layout>
    @section('title', 'Programas Derivados Sectoriales')
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Programas Derivados Sectoriales') }}
        </h2>
    </x-slot>
    ...
    <div class="contenedor-principal">
        <div class="encabezado-lista my-2">
            <h2>Gestión de Programas Derivados Sectoriales</h2>
        </div>
        <div class="d-flex justify-content-end mx-4 my-4">
            <a href="{{ route('panel-cat-prog-der-sect.create') }}" class="text-decoration-none">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-warning btn-sm text-black" title="Editar"
                                    href="{{ route('panel-cat-prog-der-sect.edit', $programa->id) }}">
                                    <i class="fa-regular fa-pen-to-square"></i>
                                </a>
                                <form action="{{ route('panel-cat-prog-der-sect.destroy', $programa->id) }}"
