    ...
    <x-slot name="header">
        <div class="exec-header admin-index-header">
            <div>
                ...
                <h2 class="exec-header__title">Programas derivados sectoriales</h2>
            </div>
    ...
    <div class="admin-index">
        <div class="contenedor-principal admin-index__surface mx-auto">
            ...
            <div class="admin-index__actions">
                <a href="{{ route('panel-cat-prog-der-sect.create') }}" class="button-add-new text-decoration-none">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="admin-index-table-actions" role="group" aria-label="Acciones del programa">
                                        <a href="{{ route('panel-cat-prog-der-sect.edit', $programa->id) }}"
