<x-app-layout>
    @php
        ...
        $title = $isEdit ? 'Editar Programa Derivado Sectorial' : 'Crear Programa Derivado Sectorial';
        $action = $isEdit
            ? route('panel-cat-prog-der-sect.update', $programa->id)
            : route('panel-cat-prog-der-sect.store');
    @endphp
            ...
            <div class="container">
                <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            @include('partials.form-icono-programa', ['defaultIcono' => 'fa-industry'])
                        </div>
                        <div class="col-md-6">
                            <div class="mb-4">
