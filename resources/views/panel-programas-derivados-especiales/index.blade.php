<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Programas Derivados Especiales') }}
        </h2>
    </x-slot>
    ...
    <div class="contenedor-principal">
        <div class="encabezado-lista my-2">
            <h2>Gestión de Programas Derivados Especiales</h2>
        </div>
        <div class="d-flex justify-content-end mx-4 my-4">
            <a href="{{ route('panel-cat-prog-der-esp.create') }}" class="text-decoration-none">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-warning btn-sm text-black" title="Editar"
                                    href="{{ route('panel-cat-prog-der-esp.edit', $programa->id) }}">
