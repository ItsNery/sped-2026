<x-app-layout>
    @php
        ...
        $title = $isEdit ? 'Editar Programa Derivado Especial' : 'Crear Programa Derivado Especial';
        $action = $isEdit
            ? route('panel-cat-prog-der-esp.update', $programa->id)
            : route('panel-cat-prog-der-esp.store');
    @endphp
            ...
            <div class="container">
                <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            @include('partials.form-icono-programa', ['defaultIcono' => 'fa-star'])
                        </div>
                        <div class="col-md-6">
                            <div class="mb-4">
                    ...
                    <div class="mb-3 pb-3 d-flex justify-content-end">
                        ...
                        <a href="{{ route('panel-cat-prog-der-esp.index') }}" class="text-decoration-none">
