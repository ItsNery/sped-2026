...
@endsection
@section('content')
{{-- <img src="{{ asset('img/Banners/Banner_PED/banner_eje4_plan2.jpg') }}" class="w-100 px-0"> --}}
<img src="{{ asset('img/Banners/Banner_PED/Eje_4.webp') }}" alt="banner del Eje 1" class="w-100 px-0">
<div class="row nav_ejes">
    ...
    <div class="col-md-2 nav_eje_item nav_eje4_active ocultar_submenu">
...
<div class="row contenido">
    ...
    <div class="col-sm-12 col-md-7 objetivo_4">
        <p>
            ...
            El progreso debe ir de la mano con el respeto al medio
