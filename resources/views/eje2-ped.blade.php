...
@endsection
@section('content')
{{-- <img src="{{ asset('img/Banners/Banner_PED/banner_eje2_plan2.jpg') }}" class="w-100 px-0"> --}}
<img src="{{ asset('img/Banners/Banner_PED/Eje_2.webp') }}" alt="banner del Eje 1" class="w-100 px-0">
...
<div class="row nav_ejes">
    ...
    <div class="col-md-2 nav_eje_item nav_eje2_active ocultar_submenu">
...
<div class="row contenido">
    ...
    <div class="col-sm-12 col-md-7 objetivo_2">
        <p>
            ...
            Para que Puebla crezca con equidad y sostenibilidad,
