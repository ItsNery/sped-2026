...
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <nav aria-label="Navegación administrativa">
        <ul class="sidebar-nav">
            <li class="sidebar-item">
                <a class="sidebar-link {{ request()->routeIs('dashboard', 'panel-indicadores.index') ? 'active' : '' }}"
                    href="{{ $sidebarInicio }}" title="Inicio">
            ...
            @if (auth()->user()->can('ver-indicador') || auth()->user()->can('ver-municipios-convenio'))
                ...
                @can('ver-indicador')
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('panel-indicadores*') ? 'active' : '' }}"
                            href="{{ route('panel-indicadores.index') }}" title="Indicadores">
                ...
                @can('ver-municipios-convenio')
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('panel-municipios-convenio*', 'indicadores-municipales*') ? 'active' : '' }}"
                            href="{{ route('panel-municipios-convenio.index') }}" title="Municipios">
            ...
            @if ($sidebarUser?->isAdministrator())
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-usuarios*', 'usuarios*') ? 'active' : '' }}"
                        href="{{ route('panel-usuarios.index') }}" title="Usuarios">
                        <i class="fas fa-users" aria-hidden="true"></i><span>Usuarios</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-roles*') ? 'active' : '' }}"
                        href="{{ route('panel-roles.index') }}" title="Roles">
                        <i class="fas fa-user-shield" aria-hidden="true"></i><span>Roles</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-logs*') ? 'active' : '' }}"
                        href="{{ route('panel-logs.index') }}" title="Bitácora">
                        <i class="fas fa-clipboard-list" aria-hidden="true"></i><span>Bitácora</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-accesos*') ? 'active' : '' }}"
                        href="{{ route('panel-accesos.index') }}" title="Accesos">
            ...
            @auth
                @if (auth()->user()->hasRole('Enlace dependencia'))
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ asset('docs/normatividad/Manual-Instituciones.pdf') }}"
                            target="_blank" rel="noopener" title="Manual de usuario">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link"
                    ...
                    target="_blank" rel="noopener" title="Manual de indicadores">
            ...
            @if (auth()->user()->isAdministrator())
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-cat-instituciones*') ? 'active' : '' }}"
                        href="{{ route('panel-cat-instituciones.index') }}" title="Instituciones">
                        <i class="fas fa-building" aria-hidden="true"></i><span>Instituciones</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-cat-planes*') ? 'active' : '' }}"
                        href="{{ route('panel-cat-planes.index') }}" title="PEDs">
                        <i class="fas fa-map" aria-hidden="true"></i><span>PEDs</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-cat-prog-der-sect*') ? 'active' : '' }}"
                        href="{{ route('panel-cat-prog-der-sect.index') }}" title="Programas sectoriales">
                        <i class="fas fa-layer-group" aria-hidden="true"></i><span>PDs. Sectoriales</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-cat-prog-der-esp*') ? 'active' : '' }}"
                        href="{{ route('panel-cat-prog-der-esp.index') }}" title="Programas especiales">
                        <i class="fas fa-star" aria-hidden="true"></i><span>PDs. Especiales</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-cat-prog-der-reg*') ? 'active' : '' }}"
                        href="{{ route('panel-cat-prog-der-reg.index') }}" title="Programas regionales">
                        <i class="fas fa-map-location-dot" aria-hidden="true"></i><span>PDs. Regionales</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('panel-cat-prog-der-instit*') ? 'active' : '' }}"
                        href="{{ route('panel-cat-prog-der-instit.index') }}" title="Programas institucionales">
    ...
    @auth
        <div class="sidebar-footer">
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{ route('inicio') }}" title="Inicio del Portal Público" rel="noopener"
                    target="_parent">
                    <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i><span>Ver portal</span>
                </a>
            </li>
