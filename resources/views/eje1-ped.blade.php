...
{{-- <img src="{{ asset('img/Banners/Banner_PED/banner_eje1_plan2.jpg') }}" class="w-100 px-0"> --}}
<div class="row nav_ejes">
    <div class="col-md-2 nav_eje_item nav_eje1_active ocultar_submenu">
...
<div class="row contenido">
    <div class="col-sm-12 col-md-3 offset-md-1 objetivo_1">
        <h2>Enfoque</h2>
    </div>
    <div class="col-sm-12 col-md-7 objetivo">
        <p>
            La prioridad es la gente, trabajaremos para garantizar su
            salud, educación, vivienda y un desarrollo social equitativo
            que permita a cada persona vivir con dignidad y alcanzar sus
            sueños.
        </p>
    </div>
</div>
<div class="row indicador_1">
    <div class="container">
        @php
