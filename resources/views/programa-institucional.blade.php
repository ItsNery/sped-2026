...
<div class="row contenido">
    <div class="col-sm-12 col-md-3 offset-md-1 objetivo_especial">
        <img class="img-fluid" src="{{ asset($imagen) }}" title="Imagen de {{ $programa->nombre }}"
            alt="Imagen de {{ $programa->nombre }}">
    </div>
    <div class="col-sm-12 col-md-7 objetivo">
        <h2 style="color:{{ $color }}">Objetivo</h2>
        <p>{{ $descripcion }}</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-2 text-md-end">
                                        ...
                                        <div class="datos_eje1" style="color:{{ $programa->color }}">
                                            @if (is_numeric(str_replace(',', '', $indicador->dato_reciente_validado)))
                                            {{-- Aquí está el cambio: ($indicador->id == 100 ? 8 : 2) --}}
                                            {{ number_format(
                                                (float) str_replace(',', '', $indicador->dato_reciente_validado), 
                                                ($indicador->id == 100 ? 8 : 2), 
                                                '.', 
                                                ','
                                            ) }}
                                            @else
                    ...
                    <div class="card-content card_indicador1">
                        <div class="card-body text-center">
                            ...
                            <div class="datos_eje1">
                                ...
                                {{-- Aquí está el cambio: ($indicador->id == 100 ? 8 : 2) --}}
                                {{ number_format(
                                    (float) str_replace(',', '', $indicador->dato_linea_base), 
                                    ($indicador->id == 100 ? 8 : 2), 
                                    '.', 
                                    ','
                                ) }}
                    ...
                    <div class="card-content card_indicador1">
                        <div class="card-body text-center">
                            ...
                            <div class="datos_eje1">
                                ...
                                {{ number_format((float) str_replace(',', '', $indicador->meta_2024), ($indicador->id == 100 ? 8 : 2), '.', ',') }}
                                @else
