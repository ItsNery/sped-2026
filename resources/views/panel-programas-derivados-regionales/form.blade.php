<x-app-layout>
    @php
        ...
        $title = $isEdit ? 'Editar Programa Derivado Regional' : 'Crear Programa Derivado Regional';
        $action = $isEdit
            ? route('panel-cat-prog-der-reg.update', $programa->id)
            : route('panel-cat-prog-der-reg.store');
    @endphp
        ...
        <div class="contenedor-principal admin-index__surface mx-auto">
            <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        @include('partials.form-icono-programa', ['defaultIcono' => 'fa-map-location-dot'])
                    </div>
                    <div class="col-md-6">
                        <div class="mb-4">
                ...
                <div class="mb-3 pb-3 d-flex justify-content-end">
                    ...
                    <a href="{{ route('panel-cat-prog-der-reg.index') }}" class="text-decoration-none">
