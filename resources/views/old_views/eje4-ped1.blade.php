...
@section('title', 'Eje 4 del Plan Estatal de Desarrollo 2019-2024')
@section('meta-description',
    'Sección dedicada al Eje 4 del Plan Estatal de Desarrollo 2019-2024 dentro del Sistema
    de Información para el Seguimiento a la Planeación y Evaluación del Desarrollo
    del Estado de Puebla')
@section('canonical-url', url()->current())
@section('og-title',
    'Eje 4 del Plan Estatal de Desarrollo 2019-2024 - Sistema de Información para el Seguimiento a la Planeación y
...
@endsection
@section('content')
    <img src="{{ asset('img/Banners/Banner_PED/banner_eje4.jpg') }}" class="w-100 px-0">
    <div class="row nav_ejes">
        ...
        <div class="col-md-2 nav_eje3 ocultar_submenu" onclick="location.href='{{ url('/ped/eje-3') }}';"><button
                class="dropbtn">Eje
                3</button></div>
        <div class="col-md-2 nav_eje4_active ocultar_submenu" onclick="location.href='{{ url('/ped/eje-4') }}';"><button
                class="dropbtn">Eje 4</button></div>
    ...
    <div class="row contenido">
        <div class="col-sm-12 col-md-3 offset-md-1 objetivo_4">
            <h2>Objetivo</h2>
        </div>
        <div class="col-sm-12 col-md-7 objetivo_4">
            <p>Reducir las brechas de desigualdad social, generando condiciones de bienestar que contribuyan a
                satisfacer las necesidades básicas de la población y mejoren su calidad de vida.</p>
        </div>
    </div>
    <div class="row indicador_4">
        <div class="container">
                ...
                <div class="row mx-auto">
                    <div class="col-12">
                        <div class="card overflow-hidden">
                            <div class="card-content card_indicador4">
                                <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-content card_indicador4">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje4">{{ $indicador->unidad_medida }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador4">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje4">{{ $indicador->tendencia }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador4">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje4">{{ $indicador->dato_linea_base }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador4">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje4">{{ $indicador->meta_2024 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
