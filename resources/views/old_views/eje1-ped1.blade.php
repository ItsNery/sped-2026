...
@section('title', 'Eje 1 del Plan Estatal de Desarrollo 2019-2024')
@section('meta-description',
    'Sección dedicada al Eje 1 del Plan Estatal de Desarrollo 2019-2024 dentro del Sistema de Información para el
    Seguimiento a la Planeación y Evaluación del Desarrollo
    del Estado de Puebla')
@section('canonical-url', url()->current())
@section('og-title',
    'Eje 1 del Plan Estatal de Desarrollo 2019-2024 - Sistema de Información para el Seguimiento a la Planeación y
...
@section('twitter-description',
    ...
    del Estado de Puebla')
@section('content')
    <img src="{{ asset('img/Banners/Banner_PED/banner_eje1.jpg') }}" class="w-100 px-0">
    <div class="row nav_ejes">
        <div class="col-md-2 nav_eje1_active ocultar_submenu" onclick="location.href='{{ url('/ped/eje-1') }}';"><button
                class="dropbtn">Eje
                1</button></div>
    ...
    <div class="row contenido">
        <div class="col-sm-12 col-md-3 offset-md-1 objetivo">
            <h2>Objetivo</h2>
        </div>
        <div class="col-sm-12 col-md-7 objetivo">
            <p>Mejorar las condiciones de seguridad y justicia en las que se encuentra el estado, tomando como base
                la cultura de legalidad, el respeto y la protección a los derechos humanos para contar con un
                ambiente de tranquilidad.</p>
        </div>
    </div>
    <div class="indicador_1">
        <div class="container">
                        ...
                        <div class="card">
                            <div class="card-content card_indicador1">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje1">{{ $indicador->dato_linea_base }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador1">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje1">{{ $indicador->meta_2024 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
