...
@section('title', 'Eje 2 del Plan Estatal de Desarrollo 2019-2024')
@section('meta-description',
    'Sección dedicada al Eje 2 del Plan Estatal de Desarrollo 2019-2024 dentro del Sistema
    de Información para el Seguimiento a la Planeación y Evaluación del Desarrollo
    del Estado de Puebla')
@section('canonical-url', url()->current())
@section('og-title',
    'Eje 2 del Plan Estatal de Desarrollo 2019-2024 - Sistema de Información para el Seguimiento a la Planeación y
...
@section('twitter-description',
    ...
    del Estado de Puebla')
@section('content')
    <img src="{{ asset('img/Banners/Banner_PED/banner_eje2.jpg') }}" class="w-100 px-0">
    <div class="row nav_ejes">
        <div class="col-md-2 nav_eje1 ocultar_submenu" onclick="location.href='{{ url('/ped/eje-1') }}';"><button
                class="dropbtn">Eje
                1</button></div>
        <div class="col-md-2 nav_eje2_active ocultar_submenu" onclick="location.href='{{ url('/ped/eje-2') }}';"><button
                class="dropbtn">Eje
                2</button></div>
    ...
    <div class="row contenido">
        <div class="col-sm-12 col-md-3 offset-md-1 objetivo_2">
            <h2>Objetivo</h2>
        </div>
        <div class="col-sm-12 col-md-7 objetivo_2">
            <p>Fortalecer las actividades y la participación del sector primario como parte fundamental del
                desarrollo del estado, buscando impulsar las economías locales y tomar en cuenta el uso sostenible
                de los recursos naturales, acorde a las vocaciones productivas de cada región.</p>
        </div>
    </div>

    <div class="row indicador_2">
        <div class="container">
                ...
                <div class="row mx-auto">
                    <div class="col-12">
                        <div class="card overflow-hidden">
                            <div class="card-content card_indicador2">
                                <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-content card_indicador2">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje2">{{ $indicador->unidad_medida }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador2">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje2">{{ $indicador->tendencia }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador2">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje2">{{ $indicador->dato_linea_base }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador2">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje2">{{ $indicador->meta_2024 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
