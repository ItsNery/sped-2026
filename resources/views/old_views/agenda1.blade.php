...
@section('title', 'Contribución Agenda 2030 del Plan Estatal de Desarrollo 2019-2024')
@section('meta-description',
    'Sección dedicada al seguimiento al cumplimiento de la Agenda 2030 del Plan Estatal de Desarrollo 2019-2024 dentro del
    Sistema de Información para el Seguimiento a la Planeación y Evaluación del Desarrollo
    del Estado de Puebla')
@section('canonical-url', url()->current())
@section('og-title',
    'Agenda 2030 - Sistema de Información para el Seguimiento a la Planeación y Evaluación del Desarrollo
    del Estado de Puebla')
...
@section('content')
    ...
    {{-- <div class="row ligas agenda" style="margin:auto;">
        <h1>Contribución Agenda 2030 del Plan Estatal de Desarrollo 2019-2024</h1>
        <img src="{{ asset('img/pleca-SPED.png') }}" style="display:block; margin:auto;" width="100%">
        <br><br>
        <div class="col-md-1"></div>
        <div class="col-md-4 odeses" style="display:block; margin:auto;">
            @foreach ($odsResultados as $odsId => $resultados)
                <div class="flip ods">
                    <div class="front" style="background-image: url({{ asset('img/Icons_ODS/' . $odsId . '.png') }})">
                        <span class="text-shadow"></span>
                    ...
                    <div class="back">
                        <a href="#ods_{{ $odsId }}" style="text-decoration:none;">
                            <h2>
                                {{ $resultados->sum('numero_indicadores') }}
                            </h2>
                            <h4>Indicadores</h4>
                        </a>
                    </div>
        ...
        <div class="col-md-6 texto-agenda">
            <div class="ind-alineados w-100">
                <img src="{{ asset('img/Agenda-Ind.png') }}">
                <h4 class="num-ind">
                    {{ $totalIndicadores }}
                </h4>
                <div class="alineados">
                    <p>Indicadores alineados a los 17 ODS</p>
                    <p class="ods">(Objetivos de Desarrollo Sostenible)</p>
                </div>
            </div>
            <p>
            ...
            <a href="http://agenda2030.puebla.gob.mx/" target="_blank">
                <button class="btn btn2">
                    <img src="{{ asset('img/ODS-agenda.png') }}">
                    Portal Agenda 2030
                </button>
            </a>
            <!-- <a href="https://agenda2030.puebla.gob.mx/contribucin-agenda-2030" target="_blank" style="text-decoration:none;"><button class="btn btn2"><img src="assets/img/imagotipo_informe.png" style="display:block; margin:auto;" width="20%">Contribución Agenda2030</button></a> -->
        </div>
        <div class="col-md-1"></div>
    </div> --}}
    {{-- @include('layouts.modals-ods') --}}
    @include('layouts.modals-ods', ['odsResultados' => $odsResultados])
