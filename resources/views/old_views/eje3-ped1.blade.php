...
@section('title', 'Eje 3 del Plan Estatal de Desarrollo 2019-2024')
@section('meta-description',
    'Sección dedicada al Eje 3 del Plan Estatal de Desarrollo 2019-2024 dentro del Sistema
    de Información para el Seguimiento a la Planeación y Evaluación del Desarrollo
    del Estado de Puebla')
@section('canonical-url', url()->current())
@section('og-title',
    'Eje 3 del Plan Estatal de Desarrollo 2019-2024 - Sistema de Información para el Seguimiento a la Planeación y
...
@endsection
@section('content')
    <img src="{{ asset('img/Banners/Banner_PED/banner_eje3.jpg') }}" class="w-100 px-0 ">
    <div class="row nav_ejes">
        ...
        <div class="col-md-2 nav_eje2 ocultar_submenu" onclick="location.href='{{ url('/ped/eje-2') }}';"><button
                class="dropbtn">Eje
                2</button></div>
        <div class="col-md-2 nav_eje3_active ocultar_submenu" onclick="location.href='{{ url('/ped/eje-3') }}';"><button
                class="dropbtn">Eje 3</button></div>
    ...
    <div class="row contenido">
        <div class="col-sm-12 col-md-3 offset-md-1 objetivo_3">
            <h2>Objetivo</h2>
        </div>
        <div class="col-sm-12 col-md-7 objetivo_3">
            <p>Generar entornos favorables para el crecimiento económico, donde la productividad y la competitividad
                sean el pilar del desarrollo en todas las regiones del estado de manera sostenible.</p>
        </div>
    </div>
    <div class="row indicador_3">
        <div class="container">
                ...
                <div class="row mx-auto">
                    <div class="col-12">
                        <div class="card overflow-hidden">
                            <div class="card-content card_indicador3">
                                <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-content card_indicador3">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje3">{{ $indicador->unidad_medida }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador3">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje3">{{ $indicador->tendencia }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador3">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje3">{{ $indicador->dato_linea_base }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content card_indicador3">
                                <div class="card-body text-center">
                                    ...
                                    <div class="datos_eje3">{{ $indicador->meta_2024 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
