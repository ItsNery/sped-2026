...
del Estado de Puebla')
@section('content')
{{-- <img src="{{ asset('img/Banners/Banner_PED/banner_eje3_plan2.jpg') }}" class="w-100 px-0"> --}}
<img src="{{ asset('img/Banners/Banner_PED/Eje_3.webp') }}" alt="banner del Eje 1" class="w-100 px-0">
<div class="row nav_ejes">
    ...
    <div class="col-md-2 nav_eje_item nav_eje3_active ocultar_submenu">
...
<div class="row contenido">
    ...
    <div class="col-sm-12 col-md-7 objetivo_3">
        <p>
            ...
            Ninguna sociedad puede aspirar al cambio sin paz y confianza
                                ...
                                <a href="{{ route('ficha-tecnica.show', $indicador) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-2 text-md-end">
                                            <div class="ultimo">
                                                Resultado:
                                                {{ $indicador->anio_reciente_validado ?? 'Sin datos' }}
                                            </div>
                                        ...
                                        <div class="col-md-4 text-md-end mt-3"> {{-- Contenedor para la semaforización --}}
                                            ...
                                            switch (
                                            strtolower($indicador->semaforizacion_validada)
                                            ) {
                                            case 'excedido':
