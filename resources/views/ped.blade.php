        ...
        <section class="ped-dashboard__container" aria-labelledby="ped-resumen-title">
            ...
            <section class="ped-dashboard__composition" aria-labelledby="ped-composition-title">
                ...
                <div class="ped-dashboard__composition-footer">
                    ...
                    <span><i class="fas fa-building me-1"></i>{{ $composicionPlan['instituciones'] }} instituciones
                        responsables</span>
                </div>
            </section>
            ...
            <section class="ped-dashboard__methodology" id="metodologia" aria-labelledby="ped-methodology-title">
                <div class="ped-dashboard__section-heading ped-dashboard__section-heading--compact">
                    <div>
                        ...
                        <p class="ped-dashboard__section-subtitle">Criterios para interpretar correctamente las cifras del
                            tablero.</p>
                    </div>
                    ...
                    <article class="ped-dashboard__methodology-item">
                        <div>
                                ...
                                <table class="ped-dashboard__semaforo-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center">Interpretación</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="text-center">X &ge; 110%</td>
                                            <td class="text-center">
                                                <span
                                                    class="ped-dashboard__semaforo-result ped-dashboard__semaforo-result--excedido">
                                                    Excedido
                                                </span>
                                            </td>
                                            <td>
                                                El valor logrado del indicador supera a la meta, lo que puede interpretarse
                                                como una falla en el proceso de planeación o influencia de factores
                                                externos.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">91% &le; X &lt; 110%</td>
                                            <td class="text-center">
                                                <span
                                                    class="ped-dashboard__semaforo-result ped-dashboard__semaforo-result--aceptable">
                                                    Aceptable
                                                </span>
                                            </td>
                                            <td>
                                                El valor logrado del indicador se encuentra entre -9% y +10% por debajo o
                                                por encima de la meta; es decir, da cumplimiento a la meta del PED.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">71% &le; X &lt; 91%</td>
                                            <td class="text-center">
                                                <span
                                                    class="ped-dashboard__semaforo-result ped-dashboard__semaforo-result--moderado">
                                                    Moderado
                                                </span>
                                            </td>
                                            <td>
                                                El valor logrado del indicador es menor que la meta; representa un avance
                                                significativo, pero deficiente para alcanzar la meta.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">X &lt; 71%</td>
                                            <td class="text-center">
                                                <span
                                                    class="ped-dashboard__semaforo-result ped-dashboard__semaforo-result--insuficiente">
                                                    Insuficiente
                                                </span>
                                            </td>
                                            <td>
                                                El valor alcanzado del indicador está muy por debajo de la meta y representa
                                                un incumplimiento, por lo que se sugiere revisar y analizar las estrategias
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="ped-dashboard__semaforo-result ped-dashboard__semaforo-result--no-evaluable">
                                                    No Evaluable
                                                </span>
                                            </td>
                                            <td>
                                                No es posible determinar el nivel de avance del indicador en el periodo de
                                                seguimiento debido a que no se cuenta con información actualizada,
                                                comparable y validada respecto de la meta.
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <p class="ped-dashboard__semaforo-note">
                                <strong>Nota:</strong> Los resultados superiores a 110% no deben interpretarse
                                automáticamente como un desempeño favorable, dado que pueden reflejar una meta subestimada,
                                una modificación en la programación, una variación extraordinaria o un cambio en el método
                                de cálculo; por ello, deben contar con una justificación técnica.
                            </p>
                        </div>
                    </article>
                </div>
            ...
            <div class="ped-dashboard__tabs" role="tablist" aria-label="Contenido del Plan Estatal de Desarrollo">
                <button class="ped-dashboard__tab active" id="ped-ejes-tab" data-bs-toggle="pill" data-bs-target="#ped-ejes"
                    type="button" role="tab" aria-controls="ped-ejes" aria-selected="true">
                    Ejes de desarrollo
                </button>
            ...
            <div class="tab-content" id="ped-dashboard-content">
                <div class="tab-pane fade show active" id="ped-ejes" role="tabpanel" aria-labelledby="ped-ejes-tab">
                    <div class="ped-dashboard__section-heading">
                        ...
                        <p class="ped-dashboard__section-subtitle">Consulta el desempeño agregado de cada eje estratégico.
                        </p>
                    </div>
                            ...
                            <article class="ped-dashboard__eje-card"
                                ...
                                <div class="ped-dashboard__card-footer">
                                    <span class="ped-dashboard__card-footer-label">
                                        Avance promedio ·
                                        {{ $eje['indicadores_evaluables'] }}/{{ $eje['total_indicadores'] }} evaluables
                                    </span>
                                    <strong
                                        class="ped-dashboard__card-value">{{ number_format($eje['avance'], 2) }}%</strong>
                                </div>
                            </article>
                        @endforeach
                    </div>
                ...
                <div class="tab-pane fade" id="ped-programas" role="tabpanel" aria-labelledby="ped-programas-tab">
                    <div class="ped-dashboard__section-heading">
                        ...
                        <p class="ped-dashboard__section-subtitle">Explora los programas que instrumentan las prioridades
                            del PED.</p>
                    </div>
                    @php
                            ...
                            @foreach ($programasOrdenados as $tipo => $programas)
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link @if ($loop->first) active @endif"
                                        id="ped-tab-{{ Illuminate\Support\Str::slug($tipo) }}" data-bs-toggle="pill"
                                ...
                                <div class="tab-pane fade @if ($loop->first) show active @endif ped-program-pane"
                                    ...
                                    @if ($tipo === 'Institucionales' && $gruposInstitucionales->isNotEmpty())
                                        <div class="d-flex justify-content-center flex-wrap gap-2 mb-4"
                                            ...
                                            <button
                                                class="btn btn-danger btn-sm rounded-pill px-3 py-1 ped-group-filter-btn active"
                                                data-group-filter="all" type="button">
                                                Todos
                                            </button>
                                            @foreach ($gruposInstitucionales as $grupo)
                                                <button
                                                    class="btn btn-outline-danger btn-sm rounded-pill px-3 py-1 ped-group-filter-btn"
                                    ...
                                    <div class="ped-dashboard__programas-grid">
                                        @foreach ($programas as $programa)
                                            <article class="ped-dashboard__programa-card ped-program-card"
                                                ...
                                                <div id="gauge-prog-{{ $programa['tipo_slug'] }}-{{ $programa['id'] }}"
                                                    class="ped-dashboard__card-gauge"></div>
                                                <div class="ped-dashboard__card-footer">
                                                    <span class="ped-dashboard__card-footer-label">
                                                        Avance promedio ·
                                                    ...
                                                    <strong
                                                        class="ped-dashboard__card-value">{{ number_format($programa['avance'], 2) }}%</strong>
                                                </div>
                                            </article>
                                        @endforeach
                                    </div>
                                    <p class="ped-dashboard__empty ped-program-empty d-none">No hay programas que coincidan
                                        con la búsqueda.</p>
                                </div>
                            @endforeach
                        </div>
...
@section('jss-final')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @foreach ($ejesData as $eje)
                createGauge('gauge-eje-{{ $eje['id'] }}', @json($eje['avance']),
                    @json($eje['semaforo_color']));
            @endforeach
            @foreach ($programasData as $programa)
                createGauge('gauge-prog-{{ $programa['tipo_slug'] }}-{{ $programa['id'] }}',
                    @json($programa['avance']), @json($programa['semaforo_color']));
            @endforeach
            ...
            function filterPrograms() {
                ...
                document.querySelectorAll('.ped-program-pane').forEach(function(pane) {
                    ...
                    pane.querySelectorAll('.ped-program-card').forEach(function(card) {
                        ...
                        const matchesGroup = activeGroup === 'all' || (card.dataset.grupo || '') ===
                            activeGroup;
