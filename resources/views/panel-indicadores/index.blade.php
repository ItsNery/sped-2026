                    ...
                    @elseif ($mostrarBotonGenerarReporte)
                        <div class="d-flex justify-content-end me-4 mt-1">
                            <a href="{{ route('generarReporte', $user->id) }}" class="btn btn-danger text-white"
                                ...
                                {{ isset($reporteGenerado) && $reporteGenerado ? 'Reimprimir Reporte' : 'Generar Reporte' }}
                            </a>
                        </div>
                    @else
                        {{-- No mostrar nada --}}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="admin-index-table-actions" role="group"
                                                    ...
                                                    @else
                                                        <span
                                                            class="admin-index-table-action admin-index-table-action--updated">Actualizado</span>
                                                        <span
                                                            class="admin-index-table-action admin-index-table-action--pending">Sin
                                                            validar</span>
                                                    @endif
                                                </div>
                                            </td>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const hasOption = (select, value) => Array.from(select.options).some((option) => option.value ===
                    value);
